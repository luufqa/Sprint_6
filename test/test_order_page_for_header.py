...
class Test:
    ...
    def test_order_page_for_header(self, driver, first_name, last_name, address, st_subway, phone, date, comment, expected_result):
        ...
        page.order_for_header(driver)
        order_for_header_button_complete = page.order_car(driver)
